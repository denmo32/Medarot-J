...
export const MessageTemplates = {
    ...
    ATTACK_MISSED: '{attackerName}の攻撃は空を切った！', // ターゲットがいない場合

    // --- 戦闘結果 ---
    ATTACK_EVADED: '{targetName}は攻撃を回避！',
    GUARDIAN_TRIGGERED: '{guardianName}のガード発動！',
    GUARDIAN_DAMAGE: '味方への攻撃を庇う！ {guardianName}の{partName}に{damage}ダメージ！',
    ...
    // --- 行動中断 ---
    CANCEL_PART_BROKEN: '{actorName}の行動予約パーツが破壊されたため、放熱に移行！',
