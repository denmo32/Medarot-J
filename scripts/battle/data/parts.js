...
export const PARTS_DATA = {
    ...
    [PartInfo.HEAD.key]: {
        ...
        'head_002': { name: 'ヘッドソード', maxHp: 50, action: '格闘', type: '殴る', trait: 'ソード', success: 60, might: 10, role: { ...PartRoles.DAMAGE, actionType: ActionType.MELEE }, targetTiming: TargetTiming.POST_MOVE, postMoveTargeting: 'NEAREST_ENEMY' },
        ...
        'head_004': { name: 'ヘッドハンマー', maxHp: 30, action: '格闘', type: '我武者羅', trait: 'ハンマー', success: 50, might: 30, role: { ...PartRoles.DAMAGE, actionType: ActionType.MELEE }, targetTiming: TargetTiming.POST_MOVE, postMoveTargeting: 'NEAREST_ENEMY' },
        ...
        'head_006': { name: 'ヘッドリペア', maxHp: 50, action: '回復', type: '修復', trait: 'リペア', success: 50, might: 40, role: PartRoles.HEAL, targetTiming: TargetTiming.POST_MOVE, postMoveTargeting: 'MOST_DAMAGED_ALLY' },
        'head_007': { name: 'ヘッドグリッチ', maxHp: 45, action: '妨害', type: '妨害', trait: 'グリッチ', success: 70, might: 0, role: PartRoles.SUPPORT_GLITCH, targetTiming: TargetTiming.POST_MOVE, postMoveTargeting: 'NEAREST_ENEMY' },
    ...
    [PartInfo.RIGHT_ARM.key]: {
        ...
        'rarm_002': { name: 'ライトソード', maxHp: 50, action: '格闘', type: '殴る', trait: 'ソード', success: 55, might: 30, role: { ...PartRoles.DAMAGE, actionType: ActionType.MELEE }, targetTiming: TargetTiming.POST_MOVE, postMoveTargeting: 'NEAREST_ENEMY' },
        ...
        'rarm_004': { name: 'ライトハンマー', maxHp: 40, action: '格闘', type: '我武者羅', trait: 'ハンマー', success: 80, might: 18, role: { ...PartRoles.DAMAGE, actionType: ActionType.MELEE }, targetTiming: TargetTiming.POST_MOVE, postMoveTargeting: 'NEAREST_ENEMY' },
		...
		'rarm_006': { name: 'ライトリペア', maxHp: 50, action: '回復', type: '修復', trait: 'リペア', success: 50, might: 40, role: PartRoles.HEAL, targetTiming: TargetTiming.POST_MOVE, postMoveTargeting: 'MOST_DAMAGED_ALLY' },
        'rarm_007': { name: 'ライトグリッチ', maxHp: 55, action: '妨害', type: '妨害', trait: 'グリッチ', success: 80, might: 0, role: PartRoles.SUPPORT_GLITCH, targetTiming: TargetTiming.POST_MOVE, postMoveTargeting: 'NEAREST_ENEMY' },
    ...
    [PartInfo.LEFT_ARM.key]: {
        ...
        'larm_002': { name: 'レフトソード', maxHp: 50, action: '格闘', type: '我武者羅', trait: 'ソード', success: 50, might: 35, role: { ...PartRoles.DAMAGE, actionType: ActionType.MELEE }, targetTiming: TargetTiming.POST_MOVE, postMoveTargeting: 'NEAREST_ENEMY' },
        ...
        'larm_004': { name: 'レフトハンマー', maxHp: 70, action: '格闘', type: '殴る', trait: 'ハンマー', success: 40, might: 10, role: { ...PartRoles.DAMAGE, actionType: ActionType.MELEE }, targetTiming: TargetTiming.POST_MOVE, postMoveTargeting: 'NEAREST_ENEMY' },
    	...
    	'larm_006': { name: 'レフトリペア', maxHp: 50, action: '回復', type: '修復', trait: 'リペア', success: 50, might: 40, role: PartRoles.HEAL, targetTiming: TargetTiming.POST_MOVE, postMoveTargeting: 'MOST_DAMAGED_ALLY' },
        'larm_007': { name: 'レフトグリッチ', maxHp: 55, action: '妨害', type: '妨害', trait: 'グリッチ', success: 80, might: 0, role: PartRoles.SUPPORT_GLITCH, targetTiming: TargetTiming.POST_MOVE, postMoveTargeting: 'NEAREST_ENEMY' },
