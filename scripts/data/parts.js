...
export const PARTS_DATA = {
    ...
    [PartInfo.HEAD.key]: {
        ...
        'head_004': { name: 'ヘッドハンマー', maxHp: 30, action: '格闘', type: AttackType.RECKLESS, trait: 'ハンマー', success: 50, might: 30, role: { key: PartRoles.DAMAGE.key, actionType: ActionType.MELEE }, actionKey: ActionDefinitionKey.RECKLESS_STRIKE },
    ...
    [PartInfo.RIGHT_ARM.key]: {
        ...
        'rarm_004': { name: 'ライトハンマー', maxHp: 40, action: '格闘', type: AttackType.RECKLESS, trait: 'ハンマー', success: 80, might: 18, role: { key: PartRoles.DAMAGE.key, actionType: ActionType.MELEE }, actionKey: ActionDefinitionKey.RECKLESS_STRIKE },
    ...
    [PartInfo.LEFT_ARM.key]: {
        ...
        'larm_002': { name: 'レフトソード', maxHp: 50, action: '格闘', type: AttackType.RECKLESS, trait: 'ソード', success: 50, might: 35, role: { key: PartRoles.DAMAGE.key, actionType: ActionType.MELEE }, actionKey: ActionDefinitionKey.RECKLESS_STRIKE },
